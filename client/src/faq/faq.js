          ...
          <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl">
            <div className="md:flex">
              ...
              <div className="p-8">
                ...
                <p className="mt-2 text-gray-500">Since I use crazy passwords, I feel safer than usual, in La Once I've seen all kinds of things, so I can expect anything, but now, my security is amazing.</p>
              </div>
            </div>
          </div>
        </div>
